...
const DashboardKPIsView: React.FC<DashboardKPIsViewProps> = ({
	cards,
	dirtyRooms,
}) => {
	return (
								...
								<div className="flex items-center gap-2 mt-2 px-3 py-1.5 bg-muted border border-border rounded-full w-fit">
									<div
										className={cn(
											...
											card.glow.replace("bg-", "bg-").split(" ")[0],
										)}
									/>
						...
						<div className="relative z-10 p-5 flex items-center justify-between gap-4">
							<div className="flex items-center gap-4">
								...
								<div className="space-y-0.5">
									<p className="text-rose-200 font-bold text-sm tracking-tight">
										Prioridad de Mantenimiento Requerida
									</p>
									<p className="text-rose-500/70 text-xs font-medium">
										...
										en estado post-check-out pendientes de sanitización
										inmediata.
									</p>
								</div>
							</div>
