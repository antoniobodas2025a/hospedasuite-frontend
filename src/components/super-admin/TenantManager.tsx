            ...
            {hotels?.map((hotel) => (
              <tr key={hotel.id} className='hover:bg-white/5 transition-colors group'>
                ...
                <td className='p-6 flex justify-end gap-3 items-center'>
                  ...
                  <button onClick={() => handleSeed(hotel.id, hotel.name)} disabled={isProcessing} className='p-2 bg-indigo-500/10 text-indigo-400 hover:bg-indigo-500 hover:text-white rounded-[var(--radius-squircle-md)] transition-all border border-indigo-500/20 disabled:opacity-50' title='Inyectar Matriz de Demostración'>
                    <Rocket size={16} />
                  </button>

                  <button onClick={() => setEditingHotel(hotel)} className='p-2 bg-blue-500/10 text-blue-400 hover:bg-blue-500 hover:text-white rounded-[var(--radius-squircle-md)] transition-all border border-blue-500/20' title='Editar Propiedad'>
                    <Edit size={16} />
                  </button>
                  ...
                  <button onClick={() => handleDelete(hotel.id, hotel.owner_id)} disabled={isProcessing} className='p-2 bg-red-500/10 text-red-400 hover:bg-red-500 hover:text-white rounded-[var(--radius-squircle-md)] transition-all border border-red-500/20 disabled:opacity-50'>
                    <Trash2 size={16} />
                  </button>
