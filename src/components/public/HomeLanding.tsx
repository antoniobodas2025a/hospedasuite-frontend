    ...
    <div className='min-h-screen bg-background font-sans'>
      ...
      <header className='relative h-[80vh] flex items-center justify-center'>
        ...
        <div className='relative z-10 text-center px-4 max-w-4xl mx-auto space-y-6'>
          ...
          >
            Experimenta el lujo y la comodidad en el corazon de{' '}
          ...
          <div className='max-w-5xl mx-auto bg-card rounded-[2.5rem] p-4 shadow-2xl flex flex-col md:flex-row gap-4 items-center border border-border'>
            <div className='flex-1 w-full flex items-center gap-4 px-6 py-2 border-b md:border-b-0 md:border-r border-border'>
              ...
              <div>
                ...
                <input
                  type='date'
                  className='font-bold text-foreground outline-none bg-transparent w-full'
                  onChange={(e) =>
      ...
      <section className='pt-32 pb-20 px-4 max-w-7xl mx-auto'>
        <div className='text-center mb-16 space-y-2'>
          ...
          <p className='text-muted-foreground'>
            Espacios disenados para tu descanso absoluto.
          </p>
        </div>
            ...
            >
              ...
              <div className='p-8 flex-1 flex flex-col'>
                ...
                <p className='text-sm text-muted-foreground leading-relaxed mb-6 flex-1'>
                  {room.description ||
                    'Una habitacion comoda con todas las amenidades necesarias para una estadia inolvidable.'}
                </p>
                ...
                <div className='flex items-end justify-between pt-6 border-t border-border/40'>
                  ...
                  <Link
                    ...
                    className='w-12 h-12 rounded-full bg-foreground text-background flex items-center justify-center hover:bg-brand-600 transition-colors shadow-lg'
                    aria-label='Reservar'
                  >
                    <ArrowRight size={20} />
                  </Link>
      ...
      {/* 5. FOOTER */}
      <footer className='bg-foreground text-background pt-20 pb-10 px-4'>
        <div className='max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-4 gap-12 mb-16'>
          ...
          <div>
            <h5 className='font-bold mb-6 text-background/80'>Contacto</h5>
            <ul className='space-y-4 text-background/60 text-sm'>
              <li className='flex items-center gap-2'>
                <MapPin size={16} /> {hotel.address || 'Sin direccion'}
              </li>
              <li className='flex items-center gap-2'>
                <Phone size={16} /> {hotel.phone || 'Sin telefono'}
              </li>
            </ul>
          </div>
          <div>
            <h5 className='font-bold mb-6 text-background/80'>Legal</h5>
            <ul className='space-y-4 text-background/60 text-sm'>
        ...
        <div className='border-t border-background/20 pt-10 text-center text-background/40 text-xs font-bold uppercase tracking-widest'>
