    ...
    <div className="bg-zinc-950 text-white min-h-screen flex flex-col items-center justify-center p-6 relative overflow-hidden">
      ...
      <main className="relative z-10 max-w-md w-full text-center space-y-8">
        ...
        <p className="text-zinc-400 text-lg leading-relaxed px-2">
          Aquí tienes tu acceso directo a la lista VIP de Totiao para que sepas el día exacto de apertura.
        </p>

        {/* VIP Form */}
        <div className="pt-4 space-y-4">
          <form
            action="https://wa.me/?text=Hola%20Totiao,%20vengo%20de%20Instagram%20y%20quiero%20estar%20en%20la%20lista%20VIP%20secreta%20de%20apertura.%20%F0%9F%A5%A9%F0%9F%94%A5"
            method="get"
            target="_blank"
          ...
          >
            <input
              type="text"
              name="text"
              placeholder="Tu nombre o Instagram"
            ...
            <button
              type="submit"
              className="group w-full bg-orange-600 hover:bg-orange-500 text-white font-bold text-lg py-4 px-8 rounded-xl transition-all duration-300 transform hover:scale-[1.02] active:scale-[0.98] shadow-[0_0_40px_rgba(234,88,12,0.3)]"
            >
