...
const PRECOMPUTED: Record<string, [number, number]> = {
  ...
  'tibasosa': [5.7500, -72.9833],
  'nobsa': [5.7667, -72.9500],
  'sutamarchan': [5.6167, -73.6333],
  'sutamarchán': [5.6167, -73.6333],
  'tinjaca': [5.5667, -73.6500],
  'tinjacá': [5.5667, -73.6500],
  'sachica': [5.5833, -73.5500],
  'sáchica': [5.5833, -73.5500],
  'santa sofia': [5.7167, -73.6000],
  'santa sofía': [5.7167, -73.6000],
  'arcabuco': [5.7500, -73.4333],
  'combita': [5.6333, -73.3167],
  'cómbita': [5.6333, -73.3167],
  'iza': [5.6167, -72.9833],
  'tota': [5.5667, -73.0000],
  'aquitania': [5.5167, -72.8833],
  'mongui': [5.7167, -72.8500],
  'monguí': [5.7167, -72.8500],
  'mongua': [5.7667, -72.8000],
  'topaga': [5.7667, -72.8333],
  'tópaga': [5.7667, -72.8333],
  'gameza': [5.8000, -72.8000],
  'gámeza': [5.8000, -72.8000],
  'corrales': [5.8500, -72.8500],
  'floresta': [5.8667, -72.9167],
  'firavitoba': [5.6667, -72.9833],
  'tutaza': [6.0333, -72.8500],
  'tutazá': [6.0333, -72.8500],
  'pesca': [5.5667, -73.0500],
  'jencano': [5.5333, -72.9167],
  'cuitiva': [5.5833, -72.9667],
  'tota lago': [5.5500, -72.9167],
  'lago de tota': [5.5500, -72.9167],
  'playa blanca tota': [5.5533, -72.8833],
  'playa blanca': [5.5533, -72.8833],
  'pantano de vargas': [5.7500, -73.0833],
  'termales paipa': [5.8017, -73.1167],
  'pueblito boyacense': [5.8167, -73.0167],
  'desierto de la candelaria': [5.6500, -73.5833],
  'paramo de oceta': [5.8500, -72.8167],
  'páramo de ocetá': [5.8500, -72.8167],
  'vinedo ain karim': [5.6333, -73.5500],
  'viñedo ain karim': [5.6333, -73.5500],
  // Veredas turísticas de Boyacá
  'vereda monquira': [5.6000, -73.5333],
  'vereda monquirá': [5.6000, -73.5333],
  'vereda el salitre': [5.6500, -73.5167],
  'vereda san pedro': [5.8667, -72.8833],
  'vereda la colorada': [5.7833, -73.0500],
  'vereda el arrayan': [5.8300, -73.0300],
  'vereda el arrayán': [5.8300, -73.0300],
  'vereda boquia': [5.6000, -73.5333],
  'vereda boquía': [5.6000, -73.5333],
  'vereda el cocuy': [5.7833, -72.9000],
  'corregimiento la tagua': [5.7333, -73.0500],
  'corregimiento el encano': [5.6500, -72.9000],
};
